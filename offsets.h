...
namespace offsets
{
	...
	const DWORD dwEntityList = 0x4CFD57C;
	const DWORD dwForceAttack = 0x312EC4C;
	const DWORD dwForceAttack2 = 0x312EC58;
	const DWORD dwForceBackward = 0x312ECA0;
	const DWORD dwForceForward = 0x312ECAC;
	const DWORD dwForceJump = 0x51A0AE4;
	const DWORD dwForceLeft = 0x312EC28;
	const DWORD dwForceRight = 0x312EC1C;
	const DWORD dwGameDir = 0x631F70;
	const DWORD dwGameRulesProxy = 0x5212E2C;
	const DWORD dwGetAllClasses = 0xD107F4;
	const DWORD dwGlobalVars = 0x58BA00;
	const DWORD dwGlowObjectManager = 0x523D918;
	const DWORD dwInput = 0x51485C8;
	const DWORD dwInterfaceLinkList = 0x8C2814;
	const DWORD dwLocalPlayer = 0xCEB9BC;
	const DWORD dwMouseEnable = 0xCF1508;
	const DWORD dwMouseEnablePtr = 0xCF14D8;
	const DWORD dwPlayerResource = 0x312CFCC;
	const DWORD dwRadarBase = 0x51322DC;
	const DWORD dwSensitivity = 0xCF13A4;
	const DWORD dwSensitivityPtr = 0xCF1378;
	const DWORD dwSetClanTag = 0x896A0;
	const DWORD dwViewMatrix = 0x4CEEF94;
	const DWORD dwWeaponTable = 0x514908C;
	const DWORD dwWeaponTableIndex = 0x323C;
	const DWORD dwYawPtr = 0xCF1168;
	const DWORD dwZoomSensitivityRatioPtr = 0xCF63A8;
	const DWORD dwbSendPackets = 0xD277A;
	const DWORD dwppDirect3DDevice9 = 0xA6030;
	const DWORD force_update_spectator_glow = 0x392112;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x39E440;
	const DWORD m_bDormant = 0xED;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_pitchClassPtr = 0x5132588;
	const DWORD m_yawClassPtr = 0xCF1168;
	const DWORD model_ambient_min = 0x58ED1C;
	const DWORD set_abs_angles = 0x1C9770;
	const DWORD set_abs_origin = 0x1C95B0;
}
namespace flags
{
	const int FL_IN_AIR_STAND = 256;
	const int FL_ON_GROUND = 257;
	const int FL_IN_AIR_MOVING_TO_STAND = 258;
	const int FL_ON_GROUND_MOVING_TO_STAND = 259;
	const int FL_IN_AIR_MOVING_TO_CROUCH = 260;
	const int FL_ON_GROUND_MOVING_TO_CROUCH = 261;
	const int FL_IN_AIR_CROUCHED = 262;
	const int FL_ON_GROUND_CROUCHED = 263;
	const int FL_IN_WATER = 1280;
	const int FL_IN_PUDDLE = 1281;
	const int FL_IN_WATER_CROUCHED = 1286;
	const int FL_IN_PUDDLE_CROUCHED = 1287;
}